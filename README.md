...
- *Postman with the imported collection*: [Download Postman](https://www.postman.com/), an API testing tool, and install it on your machine. Then download the `fiskaltrust-Middleware.postman_collection.json`, either by cloning the repo or [clicking here](https://raw.githubusercontent.com/fiskaltrust/middleware-demo-postman/master/fiskaltrust-Middleware.postman_collection.json) and selecting "Save as.." in your browser, and import it into Postman
